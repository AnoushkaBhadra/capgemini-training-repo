1. Develop a function that processes a stream of log data from AWS CloudWatch, represented as a 20 array of strings called Logs. Each inner list logs contains log information, including the year, date, status, and message.
